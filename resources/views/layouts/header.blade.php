                    ...
                    <div class="col-md-6  ">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <a href="">
                                    Order Now <svg id="Capa_1" style="enable-background:new 0 0 456.029 456.029;"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 456.029 456.029" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248c0,29.184,23.552,53.248,53.248,53.248
                     c29.184,0,53.248-23.552,53.248-53.248C398.336,362.926,374.784,338.862,345.6,338.862z" />
                            ...
                            <div>
                                ...
                                <div class="detail-box">
                                    ...
                                    <div class="options">
                                        ...
                                        <a href="">
                                            <svg id="Capa_1" style="enable-background:new 0 0 456.029 456.029;"
                                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                viewBox="0 0 456.029 456.029" xml:space="preserve">
                                                <g>
                ...
                <div class="owl-carousel client_owl-carousel">
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img class="box-img" src="images/client1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img class="box-img" src="images/client2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
